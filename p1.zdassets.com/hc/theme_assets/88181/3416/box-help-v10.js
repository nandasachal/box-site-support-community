...
var BoxHelp = (function () {
  ...
  var phoneNumbers = {
    'en-us': {
      'free': '1-877-729-4269',
      'business': '1-800-875-8230',
      'premier': '1-855-570-4130',
    },
    'fr': {
      'free': '1-877-729-4269',
      'business':'0800-909-816',
      'premier': '0800-909-816',
    },
    'de': {
      'free': '1-877-729-4269',
      'business': '0800-183-3953',
      'premier': '0800-183-3953',
    },
    'ja': {
      'free': '1-877-729-4269',
    ...
    'en-gb': {
      'free': '0-808-189-0504',
      'business': '0-808-189-0504',
      'premier': '0-808-189-0504',
    },
  };
  ...
  function isFreeUser() {
    ...
    if(isUserLoggedIn() && HelpCenter.user.organizations.length === 0){
       _gaq.push(['_setCustomVar', 3 ,'UserRole','free' ,1]);
    }
  ...
  function isPremierUser() {
    if (!isFreeUser()) {
      ...
      for (var i = 0; i < orgTags.length; i++) {
        ...
        _gaq.push(['_setCustomVar', 3 ,'UserRole','premier' ,1]);
          return true;
        }
      }
  ...
  function isBusinessUser() {
    if (!isFreeUser()) {
      ...
      if (orgName) {
      _gaq.push(['_setCustomVar', 3 ,'UserRole','enterprise or business' ,1]);
        return true;
      }
